<template>
    <div class="h-screen bg-white mt-8 sm:mt-0 w-48">
        <div class="flex items-center justify-center mt-10">
            EGAZA
            <button class="absolute right-0 top-0 text-white m-1">
                <svg
        ...
        <nav class="mt-10">
            ...
            <router-link
                class="flex items-center py-2 px-8 text-gray-100 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100"
                to="/dashboard"
            >
                <svg
            ...
            >
                ...
                <span class="mx-4 font-medium">Saved Posts</span>
            </router-link>
